...
%file_label = fopen('labels/activity_labels.txt');
file_label = fopen(['labels/',path_opts.labels]);
...
for i = 1 : num_class
    ...
    %picstr = dir(['images/training/', class_name, '/*.jpg']);
    picstr = dir([path_opts.images,'/training/', class_name, '/*.jpg']);
    [row,col] = size(picstr);
